...
export class NotFoundResourceError extends CustomError<typeof NotFoundResourceError.CODE> {
  ...
  static create(msg: string, path = 'Unknown path error'): NotFoundResourceError {
